        ...
        <nav x-data="{ open: false }" class="bg-white shadow-sm">
                ...
                <div class="grid grid-cols-12 gap-4 items-center h-16">
                    ...
                    <div class="col-span-3 flex items-center">
                        <a href="{{ route('admin.dashboard') }}" class="flex items-center space-x-2">
                            ...
                            <span class="font-semibold text-lg text-gray-800">Admin Panel</span>
                        </a>
                    </div>
                    ...
                    <div class="col-span-6 hidden md:flex items-center justify-center space-x-6">
                        ...
                        <x-nav-link :href="route('admin.canteens.index')" :active="request()->routeIs('admin.canteens.*')"
                            class="text-gray-600 hover:text-green-600 transition duration-150">
                            {{ __('Kantin') }}
                        </x-nav-link>
                    ...
                    <div class="col-span-3 hidden md:flex items-center justify-end">
                        <x-dropdown align="right" width="48">
                            <x-slot name="trigger">
                                <button class="flex items-center px-3 py-2 text-sm font-medium text-gray-600 hover:text-green-600 rounded-md transition duration-150">
            ...
            <div :class="{ 'block': open, 'hidden': !open }" class="md:hidden bg-white border-t border-gray-200">
                <div class="pt-2 pb-3 space-y-1 px-4">
                    ...
                    <x-responsive-nav-link :href="route('admin.canteens.index')" :active="request()->routeIs('admin.canteens.*')"
                        class="block py-2 text-gray-600 hover:text-green-600">
                        {{ __('Kantin') }}
                    </x-responsive-nav-link>
